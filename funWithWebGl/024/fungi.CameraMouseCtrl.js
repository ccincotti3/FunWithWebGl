// Ultimately to be deprecated for KBMCtrl
...
// Need for picking bc the camera needs to be controlled in different way (Keyboard and Mouse Controller)
// Like a state machine - handle keyboard and mouse input data. Pass in objects to interpret information to be used in certain way.
Fungi.KBMCtrl = class{
  constructor(){
...
// This is the data user to the KBMCtrl
